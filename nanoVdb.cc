...
template<class GridType>
void createSkin(GridType& grid,int size_lado,int profundidad_total){
...
template<class GridType>
void promediate(GridType& gridSource,GridType& gridDestiny){
...
int main()
{
    ...
    openvdb::FloatGrid::Ptr grid =
       openvdb::FloatGrid::create(/*background value=*/2.0);
        ...
        createSkin(*grid,size_lado,profundidad_total);
